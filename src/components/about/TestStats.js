          ...
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
            ...
            <div className="relative overflow-hidden rounded-2xl pt-64 pb-10 shadow-xl">
              <img
                ...
                src="https://img.freepik.com/free-photo/businessman-big-office_53876-144319.jpg?w=1060&t=st=1689352469~exp=1689353069~hmac=a7fa3910469633220a986b285edb78626cc0a47954c500a976875cc1ce46ef1c"
                alt=""
              />
              ...
              <div className="relative px-8">
                ...
                <blockquote className="mt-8">
                  <div className="relative text-lg font-medium text-white md:flex-grow">
                    <svg
                      className="absolute top-0 left-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-green-200"
                      fill="currentColor"
                      viewBox="0 0 32 32"
                      aria-hidden="true"
                    >
                    ...
                    <p className="relative pl-5">
                      When your back is against the wall, break the goddamn
                      thing down.
                    </p>
                  </div>
                  ...
                  <footer className="mt-4">
                    <p className="text-base font-semibold text-green-100">
                      DaniMarqz, quoting Harvey Specter
                    </p>
                  </footer>
                </blockquote>
              </div>
