...
const navigation = {
    ...
    social: [
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/danimarqz_33/',
        icon: (props) => (
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/dani_marquez_33',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/Danimarqz',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <p className="text-base text-gray-500">
                Making the world a better place through building beautiful webpages.
              </p>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 DaniMarqz systems, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
